...
use rz_core::resolve::semilattice::{
...
fn test_supplemental_key_does_not_overwrite_resolved_state(version: StateResVersion) {
    ...
    let conflicted_keys = rz_core::FastSet::default();
    ...
    let iterative = rz_core::resolve::iterative::resolve_iterative_sort_with_conflicted_keys(
        &unconflicted,
        &supplemental_events,
        &map,
        version,
...
fn test_lattice_fold_parity_with_iterative() {
    ...
    let iterative = rz_core::resolve_iterative_sort(
        &unconflicted,
        &conflicted,
        &map,
        StateResVersion::V2,
