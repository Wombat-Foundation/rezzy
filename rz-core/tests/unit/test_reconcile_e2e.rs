...
fn run_round_trip(
    ...
    let mut exchange = BucketExchange::new(
        accumulated_roots,
        rz_core::reconcile::client::MAX_RECONCILIATION_ROUNDS,
