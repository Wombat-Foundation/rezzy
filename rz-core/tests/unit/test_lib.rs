...
mod tests {
    ...
    use rz_core::resolve::cdo::apply_cdo_filter;
    ...
    fn test_route_power_events_excludes_third_party_invite() {
        ...
        rz_core::route_power_events(
            &sort_set,
            &mut power_events,
            &mut non_power_events,
            rz_core::StateResVersion::V2_1_1,
        );
    ...
    fn test_expand_v2_power_events_auth_chains_functionality() {
        ...
        rz_core::expand_v2_power_events_auth_chains(
            &mut power_events,
            &mut non_power_events,
            &sort_set,
        );
    ...
    fn test_sort_priority_v2_tie_break() {
        ...
        let p_base = SortPriority {
            ...
            event: &e_base,
            version: rz_core::StateResVersion::V2,
        };
    ...
    fn test_sort_priority_clone() {
        ...
        let p = SortPriority {
            power_level: 50,
            event: &evs[0],
            version: rz_core::StateResVersion::V2_1_1,
        };
    ...
    fn test_sort_priority_cross_version_ordering_is_symmetric() {
        ...
        let p_v1 = SortPriority {
            power_level: 0,
            event: &event,
            version: rz_core::StateResVersion::V1,
        };
    ...
    fn test_v1_resolution_happy_path() {
        ...
        let sorted = rz_core::lean_kahn_sort(
            &events,
            &events,
            events.values().find(|ev| ev.event_type == "m.room.create"),
            rz_core::StateResVersion::V1,
    ...
    fn test_v2_1_strict_resolution() {
        ...
        unconflicted.insert(
            (
                rz_core::basespec::event_types::EventType::from("m.room.member"),
    ...
    fn test_v1_v2_v2_1_comparison_determinism() {
        ...
        let sorted_v1 = rz_core::lean_kahn_sort(
            &events,
            &auth,
            Some(&create_ev),
            rz_core::StateResVersion::V1,
        ...
        let sorted_v2 = rz_core::lean_kahn_sort(
            &events,
            &auth,
            Some(&create_ev),
            rz_core::StateResVersion::V2,
        ...
        let sorted_v2_1 = rz_core::lean_kahn_sort(
            &events,
            &auth,
            Some(&create_ev),
            rz_core::StateResVersion::V2_1,
    ...
    fn test_trait_coverage() {
        let v = rz_core::StateResVersion::V2;
        assert_eq!(v, rz_core::StateResVersion::V2);
        let _ = format!("{v:?}");
    ...
    fn test_complex_dag_sort() {
        ...
        let sorted_ids = rz_core::lean_kahn_sort(
            &events,
            &events,
            events.values().find(|ev| ev.event_type == "m.room.create"),
            rz_core::StateResVersion::V2,
    ...
    fn test_resolve_iterative_sort_functionality() {
        ...
        unconflicted.insert(
            (
                rz_core::basespec::event_types::EventType::from("type"),
                "key".into(),
            ),
            "id".into(),
        );
    ...
    fn test_resolve_iterative_sort_borrows_inputs() {
        ...
        let version = rz_core::StateResVersion::V2;
    ...
    fn run_batch_test(
        version: rz_core::StateResVersion,
        ...
        let result = rz_core::lean_kahn_sort(
            &events,
            &events,
            events.values().find(|ev| ev.event_type == "m.room.create"),
            version,
    ...
    fn test_cycle_detection_detailed() {
        ...
        let result = rz_core::lean_kahn_sort_with_cycle_diagnostics(
            &events,
            &events,
            events.values().find(|ev| ev.event_type == "m.room.create"),
            rz_core::StateResVersion::V2,
    ...
    fn test_lean_kahn_sort_empty_vec_on_cycles() {
        ...
        assert!(
            !sorted.is_empty(),
            "rz_core::lean_kahn_sort must fall back and resolve stuck events on cycles instead of returning an empty Vec"
        );
    ...
    fn test_cdo_causal_domination_filter() {
        ...
        // In rz_core::StateResVersion::V2_2, Bob's name change is causally dominated by Alice's ban and filtered out.
    ...
    fn test_coverage_booster_auth_cases() {
        ...
        assert_eq!(
            check_auth(
                &bad_create,
                &state,
                rz_core::basespec::rezzy_types::StateResVersion::V2_1,
                None
            ),
        ...
        assert_eq!(
            rejected_ids,
            [] as [(std::string::String, rz_core::auth::AuthError); 0]
        );
    }
    ...
    fn test_resolve_iterative_sort_cycle_power_events() {
        ...
        unconflicted.insert(
            (
                rz_core::basespec::event_types::EventType::from("m.room.power_levels"),
                String::new(),
            ),
            "INITIAL_PL".into(),
        );
    ...
    fn test_compute_state_at_with_missing_and_foreign_prev_events() {
        ...
        assert!(state_map.contains_key(&(
            rz_core::basespec::event_types::EventType::from("m.room.create"),
            String::new()
        )));
        assert_eq!(
            &state_map[&(
...
fn test_types_validate_syntactic() {
    ...
    assert_eq!(
        pre_v11.warnings,
        vec![rz_core::warnings::Warning::OversizedFieldPreV11 {
...
fn test_redaction_preserved_keys_matrix() {
    use rz_core::basespec::rezzy_types::{redaction_preserved_keys, RedactionRule};
...
fn test_content_hash_verification_on_raw_pdu() {
    use rz_core::{compute_content_hash, verify_content_hash};
...
fn test_ingest_events_stamps_caller_supplied_room_id_not_the_pdus_own() {
    ...
    for event in &events {
        assert_eq!(
            event.room_id.as_ref().map(rz_core::RoomId::as_ref),
...
fn test_apply_authorized_redactions_only_strips_authorized_targets() {
    use rz_core::auth::{apply_authorized_redactions, RoomState};
    use rz_core::StateResVersion;
...
fn test_reference_hash_is_redaction_invariant() {
    use rz_core::{redact_json, reference_hash};
...
fn test_cdo_coverage_branches() {
    ...
    let _filtered = rz_core::resolve::cdo::apply_cdo_filter(&events_map, &auth_context);
}
...
fn test_cdo_is_ancestor() {
    ...
    // Equal IDs -> true
    assert!(rz_core::resolve::cdo::is_ancestor("A", "A", &ctx));
    ...
    assert!(!rz_core::resolve::cdo::is_ancestor("missing", "B", &ctx));
    ...
    assert!(!rz_core::resolve::cdo::is_ancestor("C", "missing", &ctx));
    ...
    assert!(!rz_core::resolve::cdo::is_ancestor(
        "child_pruned",
        "and_shallow",
        &ctx
    ));
...
"#,
    ...
    assert!(
        rz_core::resolve::cdo::is_ancestor("$child", "$and", &ctx),
...
"#,
    ...
    let safe = rz_core::resolve::cdo::apply_cdo_filter(&conflicted, &auth_context);
...
"#,
    ...
    let _ = rz_core::lean_kahn_sort(
        &events_map,
        &auth,
        Some(&create_ev),
        rz_core::StateResVersion::V2_2,
        &mut std::collections::HashMap::new(),
    );
}
...
fn test_resolve_iterative_sort_with_deltas_no_duplicate_power_events() {
    use rz_core::{resolve_iterative_sort_with_deltas, LeanEvent, StateResVersion};
    use std::collections::HashMap;
...
fn test_v2_vs_v2_1_member_power_event_classification() {
    ...
    rz_core::resolve::semilattice::route_power_events(
        &sort_set,
        &mut set1_v2_power,
...
fn test_lean_event_serialize_roundtrip() {
    use rz_core::basespec::rezzy_types::DagNode as DagNodeTrait;
...
fn test_compute_state_at_v2_vs_v2_1_divergence() {
    ...
    let mut unconflicted: imbl::OrdMap<
        (rz_core::basespec::event_types::EventType, String),
        String,
    > = imbl::OrdMap::new();
    unconflicted.insert(
        (
    ...
    let jr_key: (rz_core::basespec::event_types::EventType, String) = (
        rz_core::basespec::event_types::EventType::from("m.room.join_rules"),
        String::new(),
    );
...
fn test_event_verifier_default_third_party_invite() {
    use rz_core::basespec::rezzy_types::EventVerifier;
...
fn test_dag_node_trait_on_lean_event() {
    use rz_core::basespec::rezzy_types::DagNode;
    let ev = LeanEvent::<String> {
        event_id: "ev".into(),
        depth: 42,
...
fn test_coverage_sweeper_for_unreachable_edges() {
    use rz_core::basespec::rezzy_types::{EventProvider, SortPriority};
    use rz_core::resolve::cdo::is_ancestor;
    use rz_core::resolve::semilattice::resolve_semilattice_fold;
    use rz_core::state::at::StateComputationError;
    use rz_core::state::delta::{reconstruct_state_batch, CompactedCheckpoint};
    use rz_core::{resolve_iterative_sort_with_deltas, LeanEvent, StateResVersion};
    ...
    let v1_resolved = rz_core::resolve::resolve_iterative_sort(
        &unconf,
    ...
    assert!(!resolved.contains_key(&(
        rz_core::basespec::event_types::EventType::from("m.room.topic"),
        String::new()
    )));
    assert!(deltas
        .iter()
    ...
    let sorted_cyclic = rz_core::resolve::sorting::lean_kahn_sort(
        &cyclic_kahn_events,
        &HashMap::new(),
        None,
        StateResVersion::V2,
...
impl rz_core::RawEvent for TestRawEvent {
    type Id = String;
...
fn test_parsed_event_full_coverage() {
    use rz_core::basespec::rezzy_types::{DagNode, EventLike, RawEvent};
    ...
    let parsed_default_flags = rz_core::ParsedEvent::new(&raw);
    ...
    let parsed = rz_core::ParsedEvent::new(&raw_pl);
...
fn test_parsed_event_try_new() {
    ...
    assert!(rz_core::ParsedEvent::try_new(&valid).is_ok());
    ...
    assert!(rz_core::ParsedEvent::try_new(&invalid).is_err());
}
...
fn test_lean_event_borrowed_view_accessors() {
    use rz_core::basespec::rezzy_types::{DagNode, EventLike};
...
fn test_event_like_default_methods_on_lean_event() {
    use rz_core::basespec::rezzy_types::EventLike;
...
fn test_local_auth_cache_version_invalidation() {
    use rz_core::state::at::LocalAuthCache;
...
{"event_id":"$topicB","type":"m.room.topic","state_key":"","sender":"@alice:x","depth":3,"origin_server_ts":1,"prev_events":[],"auth_events":["$create","$join"],"content":{"topic":"B"}}
    ...
    let _result = rz_core::resolve_iterative_sort_with_cache(
        &unconflicted,
        &conflicted,
        &auth_context,
        Some(&mut cache),
    ...
    let (_result2, _deltas) = rz_core::resolve_iterative_sort_with_cache_and_deltas(
        unconflicted,
        conflicted,
        &auth_context,
        Some(&mut cache2),
...
fn test_find_backward_extremities_no_gaps() {
    ...
    let gaps = rz_core::find_backward_extremities(&events_map, |_| false);
    assert!(
        gaps.is_empty(),
...
fn test_find_backward_extremities_multiple_gaps() {
    ...
    let mut gaps = rz_core::find_backward_extremities(&events_map, |_| false);
...
fn test_find_backward_extremities_with_exists_oracle() {
    ...
    let gaps = rz_core::find_backward_extremities(&events_map, |id| id == "$in_db");
...
fn test_msc4297_problem_b_resolve_state_maps_parity() {
    ...
    let mut events_map: std::collections::HashMap<String, rz_core::LeanEvent> =
        std::collections::HashMap::new();
    for ev in all_evs {
    ...
    let resolved_api =
        rz_core::resolve_state_maps(&state_maps, &events_map, rz_core::StateResVersion::V2_1);

    // Path B: manual partition + subgraph + resolve_iterative_sort (old binary path)
    let (unconflicted, conflicted_ids) =
        rz_core::partition_state_maps(state_maps.iter().map(|m| m.iter()), state_maps.len());
    let mut conflicted_events: std::collections::HashMap<String, rz_core::LeanEvent> =
        std::collections::HashMap::new();
    ...
    let subgraph = rz_core::compute_v2_1_conflicted_subgraph(&events_map, &conflicted_ids);
    for (id, ev) in subgraph {
        conflicted_events.insert(id, ev);
    }
    let resolved_manual = rz_core::resolve_iterative_sort(
        &unconflicted,
        &conflicted_events,
        &events_map,
        rz_core::StateResVersion::V2_1,
...
fn test_performance_and_correctness_dense_bifurcations() {
    ...
    let mut events: Vec<rz_core::LeanEvent> = Vec::new();
    let mut ts: u64 = 0;
    ...
    // ── Build events map ──
    let events_map: std::collections::HashMap<String, rz_core::LeanEvent> = events
        .into_iter()
        .map(|e| (e.event_id.clone(), e))
        .collect();
    ...
    let resolved_v2 =
        rz_core::resolve_state_maps(&fork_state_maps, &events_map, rz_core::StateResVersion::V2);
    ...
    // ── Correctness: V2.1 ──
    let start = std::time::Instant::now();
    let resolved_v2_1 = rz_core::resolve_state_maps(
        &fork_state_maps,
        &events_map,
        rz_core::StateResVersion::V2_1,
    );
    ...
    let start = std::time::Instant::now();
    let resolved_v2_1_1 = rz_core::resolve_state_maps(
        &fork_state_maps,
        &events_map,
        rz_core::StateResVersion::V2_1_1,
    );
    ...
    let resolved_v2_1_1_again = rz_core::resolve_state_maps(
        &fork_state_maps,
        &events_map,
        rz_core::StateResVersion::V2_1_1,
    );
    ...
    let (unconflicted, conflicted_ids) = rz_core::partition_state_maps(
    ...
    // V2.1.1 parity
    let resolved_manual_v2_1_1 = rz_core::resolve_iterative_sort(
        &unconflicted,
        &conflicted_events,
        &events_map,
        rz_core::StateResVersion::V2_1_1,
...
fn test_conflicted_keys_derived_before_cdo() {
    use rz_core::basespec::event_types::EventType;
    use rz_core::{cdo, resolve_iterative_sort_with_deltas, LeanEvent, StateResVersion};
    use std::collections::HashMap;
...
fn test_soft_fail_and_rejected_state_events_on_linear_chain() {
    use rz_core::{compute_state_at_streaming, StateUpdate};
    use std::collections::HashMap;
...
"#,
    ...
    let name_key = (
        rz_core::basespec::event_types::EventType::from("m.room.name"),
        String::new(),
    );
    let topic_key = (
        rz_core::basespec::event_types::EventType::from("m.room.topic"),
    ...
    let mut streamed: Option<rz_core::SharedState<String, String>> = None;
