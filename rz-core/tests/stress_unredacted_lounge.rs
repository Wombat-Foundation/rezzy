...
fn resolve_v2_1_from_subgraph(
    ...
    let v2_1_conflicted = rz_core::compute_v2_1_conflicted_subgraph(&full_context, conflicted_eids);
...
fn test_checkpoint_partial_join_resolution() {
    ...
    let v2_1_conflicted =
        rz_core::compute_v2_1_conflicted_subgraph(&full_context, &post_join_conflicted);
